...
| [notion-integration](./notion-integration/) | Integrate Claude Code with Notion to create pages, search your workspace, and sync project documentation | **Commands:** `/notion:create-page`, `/notion:search`, `/notion:sync-docs` - Notion workspace integration<br>**Agents:** `notion-page-creator`, `notion-content-formatter` - Structured page creation and markdown conversion<br>**Skill:** `notion-integration` - Auto-invoked guidance for Notion tasks<br>**Hook:** SessionStart - Validates API key and injects Notion context |
